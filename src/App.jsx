...
<div className="flex flex-wrap mx-1 justify-around border-t-2 border-b-5 my-2 rounded-sm" >
    ...
    <div className="fixed bottom-3 right-2 mb-4 mr-4 z-10">
    <div>
      <a
